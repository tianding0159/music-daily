...
.card.in::before{content:""; position:absolute; inset:0; z-index:5; pointer-events:none;
  background:linear-gradient(90deg,rgba(15,14,18,.58) 0%,rgba(15,14,18,.40) 55%,rgba(15,14,18,.26) 100%);
...
.card .big-art .thud{position:absolute; left:50%; top:50%; width:14px; height:14px; z-index:4;
  border:1.5px solid rgba(255,255,255,.55); transform:translate(-50%,-50%) scale(0);
